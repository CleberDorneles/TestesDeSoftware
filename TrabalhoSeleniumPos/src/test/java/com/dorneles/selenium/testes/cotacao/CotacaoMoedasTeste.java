package com.dorneles.selenium.testes.cotacao;
...
import com.dorneles.selenium.telas.cotacao.TelaCotacoesUOL;
import com.dorneles.selenium.telas.cotacao.TelaHistoricoMoeda;
...
public class CotacaoMoedasTeste extends SeleniumTest {
	...
	public void prepararCotacoes() {
		this.selenium = new SeleniumWebDriver(super.driver);
	...
	public void testeConsultaLimiteCotaViagemExteriorEmReais() {
		telaCotacoes.consultarLimiteCotaViagemEmReais();
	}
